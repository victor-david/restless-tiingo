namespace Restless.Tiingo.Core
{
    internal static class JsonId
    {
        ...
        public const string AdjustedHigh = "adjHigh";
        public const string AdjustedLow = "adjLow";
        public const string AdjustedOpen = "adjOpen";
        public const string AdjustedVolume = "adjVolume";
        ...
        public const string DividendCash = "divCash";
        ...
        public const string LastSizeNotional = "lastSizeNotional";
        public const string LowPrice = "low";
        ...
        public const string QuoteTimestamp = "quoteTimestamp";
        ...
        public const string TopOfBookData = "topOfBookData";
        public const string TradesDone = "tradesDone";
